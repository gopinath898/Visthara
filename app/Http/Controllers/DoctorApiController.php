...
class DoctorApiController extends Controller
{
    public function apiDoctorLogin(Request $request)
    {
        ...
        if(Auth::attempt(['email' => request('email'), 'password' => request('password')]))
        {
            ...
            if($userDoctor->hasRole('Therapist'))
            {
                        ...
                        if($doctor->based_on == 'subscription')
                        {
                            ...
                            if ($subscription)
                            {
                                ...
                                if($subscription->end_date > $cDate)
                                {
                                    ...
                                    return response(['success' => true, 'data' => $userDoctor , 'msg' => 'Therapist Login successfully']);
                                }
                                else
                                {
                                    // subscription expire
            ...
            {
                return response(['success' => false , 'msg' => 'Only therapist can login']);
            }
        }
        else
        {
    ...
    public function apiDoctorAppointment()  
    {
        ...
        return response(['success' => true , 'data' => $appointments , 'msg' => 'Therapist Today appointment']);
    }
    ...
    public function apiSingleAppointment($id)
    {
        ...
        return response(['success' => true , 'data' => $appointment , 'msg' => 'Therapist Today appointment']);
    }
    ...
    public function apiWorkingHours()
    {
        ...
        return response(['success' => true , 'data' => $timing , 'msg' => 'Therapist Timing']);
    }
    ...
    public function apiUpdateWorkingHours(Request $request)
    {
        ...
        $working->update($data);
        return response(['success' => true , 'msg' => 'Timing updated']);
    }
    ...
    public function apiLoginDoctor(Request $request)
    {
        ...
        return response(['success' => true,'data' => $doctor , 'msg' => 'login therapist details']);
    }
