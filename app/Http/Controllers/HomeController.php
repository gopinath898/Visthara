...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $loggeduser = Auth::user()->load('roles');

        if($loggeduser->hasRole('Therapist')){
        ...
        $categories = Category::whereStatus(1)->get()->take(5);
        $treatments = Treatments::whereStatus(1)->get();
        return view('home',compact('orderCharts','users','allUsers','allDoctors','totalDoctors','totalUsers','totalAppointments','categories','treatments'));
    }
