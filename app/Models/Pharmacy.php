...
class Pharmacy extends Model
{
    ...
    protected $fillable = ['user_id','description','image','name','email','phone','address','lat','lang','start_time','end_time','commission_amount','status','is_shipping','delivery_charges','language','low','moderate','high','short_desc','conditions','rec_low','rec_moderate','rec_high'];
