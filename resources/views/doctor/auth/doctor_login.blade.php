...
@section('title',__('Therapist login'))
      ...
      <div class="col-lg-5 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
        <div class="p-4 m-3">
          ...
          <div class="text-center mt-5">
            {{__("does not have an account?")}}<a href="{{ url('therapy/therapy_signup') }}">&nbsp;{{__('SignUp')}}</a>
        </div>
        </div>
      </div>
      <div class="col-lg-7 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="{{ url('assets/img/tlogin.JPEG') }}">
