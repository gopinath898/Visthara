            ...
            <div class="card-body">
                <div class="row mt-4">
                    <div class="col-lg-2 col-md-4">
                        <label for="Doctor_image" class="ul-form__label"> {{__('Therapist image')}}</label>
            ...
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-4 form-group">
                        ...
                        <select name="treatment_id" id="treatment_id" class="select2 @error('treatment_id') is-invalid @enderror">
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <select name="category_id" id="category_id" class="select2 @error('category_id') is-invalid @enderror">
