    ...
    <section class="section">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-6">
                ...
                <div class="card  card-table flex-fill">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('Latest Clients List') }}</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="dataTable" class="datatable table table-hover table-center mb-0">
                                ...
                                <tbody>
                                    @foreach ($allUsers as $allUser)
                                        <tr>
                                            <td>
                                                <a href="{{ url('patient/' . $allUser->id) }}"
                                                    class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="{{ $allUser->fullImage }}"
                                                        alt="User Image"></a>
            ...
            {{-- <div class="col-md-12 col-lg-6">
                <div class="card card-chart">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('Therapist - Clients') }}</h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6 d-flex">
                {{-- <div class="card card-table flex-fill">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('Therapist List') }}</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{ url('doctor/' . $doctor->id . '/' . Str::slug($doctor->name) . '/dashboard') }}"
                                                    class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="{{ $doctor->full_image }}"
                                                        alt="User Image" style="max-height: 250px;"></a>
                                                <a
                                                    href="{{ url('doctor/' . $doctor->id . '/' . Str::slug($doctor->name) . '/dashboard') }}">{{ $doctor->name }}</a>
                                            </td>
