<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            {{-- @can('superadmin_dashboard')
                <li class="{{ $activePage == 'enquiries' ? 'active' : '' }}">
            ...
            @can('radiology_category_access')
                ...
                <li class="{{ $activePage == 'faq_data' ? 'active' : '' }}">
                    <a href="{{ url('faq_data') }}">
            ...
            {{-- @if (auth()->user()->hasRole('Therapist'))
                <li class="{{ $activePage == 'conversation' ? 'active' : '' }}">
            ...
            @if (auth()->user()->hasRole('super admin'))
                ...
                <li class="{{ $activePage == 'transcations' ? 'active' : '' }}">
                    <a href="{{ url('/patient/alltranscations') }}">
            ...
            @if (Gate::check('subscription_access') || Gate::check('subscription_history'))
                @if (auth()->user()->hasRole('Therapist'))
                    ...
                    @if ($doctor->based_on == 'subscription')
                        <li
                            class="{{ $activePage == 'subscription' ? 'active' : '' }} || {{ $activePage == 'subscription_history' ? 'active' : '' }}">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="{{ $activePage == 'subscription_history' ? 'active' : '' }}">
                                    <a class="nav-link"
                                        href="{{ url('subscription_history') }}">{{ __('subscription history') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif
                ...
                <!-- <li class="{{ $activePage == 'user_report' ? 'active' : '' }} || {{ $activePage == 'doctor_report' ? 'active' : '' }}">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="{{ $activePage == 'doctor_report' ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ url('doctor_report') }}">{{ __('Therapist Report') }}</a>
                                    </li>
                                </ul>
                              </li> -->
            @endcan --}}
            ...
            @if (auth()->user()->hasRole('Therapist'))
                <li class="{{ $activePage == 'therapy' ? 'active' : '' }}">
                    <a href="{{ url('therapy/myprofile') }}">
                        <i class="fas fa-stethoscope"></i>
