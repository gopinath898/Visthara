                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="treatment_id" id="treatment_id" class="select2">
                            ...
                            <div class="form-group">
                                <label class="col-form-label">{{__('Order')}}</label>
                                <input type="text" value="{{ $category->order_by }}" name="order_by" class="form-control @error('order_by') is-invalid @enderror" required>
                                @error('order_by')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
