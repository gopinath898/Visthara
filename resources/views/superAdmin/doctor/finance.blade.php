...
@section('title',__('Show Therapist'))
@section('content')

<section class="section">
    @include('layout.breadcrumb',[
        'title' => __('Therapist Finance Details'),
        'url' => url('doctor'),
            ...
            <div class="profile-widget-header">
                ...
                <div class="btn-group mb-2 dropleft float-right p-3">
                    ...
                    <div class="dropdown-menu" x-placement="bottom-start">
                      ...
                      <a class="dropdown-item" href="{{ url('doctor/'.$doctor->id.'/'.Str::slug($doctor->name).'/patients') }}">{{ __('Client') }}</a>
                    </div>
                </div>
            </div>
        ...
        @if ($doctor->based_on == 'commission')
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="badge badge-success">{{__('admin gives to therapist')}}</span>&nbsp;
                    <span class="badge badge-danger">{{__('therapist gives to admin')}}</span>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
