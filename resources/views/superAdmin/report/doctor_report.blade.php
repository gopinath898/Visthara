...
@section('title',__('Therapist Report'))
@section('content')

<section class="section">
    @include('layout.breadcrumb',[
        'title' => __('Therapist Report'),
    ])
    @if (session('status'))
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                      <div class="card-header">
                        <h4>{{__('Subscription Based Therapist')}}</h4>
                      </div>
                      <div class="card-body">
            ...
            <div class="col-xl-4 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                      <div class="card-header">
                        <h4>{{__('Commission Based Therapist')}}</h4>
                      </div>
                      <div class="card-body">
                ...
                <div class="table-responsive text-center">
                    <table class="w-100 display table datatable">
                        <thead>
                            <tr>
                                <th> # </th>
                                <th>{{__('Therapist Image')}}</th>
                                <th>{{__('Name')}}</th>
                                <th>{{__('Email')}}</th>
                                <th>{{__('Phone')}}</th>
                                <th>{{__('Based On')}}</th>
                                <th>{{__('Total Appointment')}}</th>
                                <th>{{__('Therapist Status')}}</th>
                            </tr>
                        </thead>
                        <tbody>
