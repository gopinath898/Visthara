                        ...
                        @if($setting->license_verify == 1)
                            <div class="tab-pane show active" id="solid-justified-tab1">
                                <form action="{{url('update_general_setting')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="app_id" class="col-form-label"> {{__('Order Cancel Thresold By Therapist(In Minutes)')}}</label>
                                    ...
                                    <div class="form-group">
                                        <label for="default_base_on" class="col-form-label"> {{__("Therapist register with Website it's based on commission or subscription?")}}</label>
                            ...
                            <div class="tab-pane" id="solid-justified-tab3">
                                <form action="{{url('update_verification_setting')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            <label class="col-form-label">{{__('User and Therapist verification')}}</label>
                                            <label class="cursor-pointer">
                            ...
                            <div class="tab-pane" id="solid-justified-tab6">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="col-form-label">{{__('Send Mail To Client?')}}</label>
                                        <label class="cursor-pointer">
                                    ...
                                    <div class="col-md-3">
                                        <label class="col-form-label">{{__('Send Mail To Therapist?')}}</label>
                                        <label class="cursor-pointer">
                                    ...
                                    <div class="col-md-3">
                                        <label class="col-form-label">{{__('Send Push Notification To Client?')}}</label>
                                        <label class="cursor-pointer">
                                    ...
                                    <div class="col-md-3">
                                        <label class="col-form-label">{{__('Send Push Notification To Therapist?')}}</label>
                                        <label class="cursor-pointer">
                                ...
                                <label class="mt-5 text-primary" class="col-form-label">{{__('For Client :: ')}}</label>
                                ...
                                <label class="mt-5 text-primary" class="col-form-label">{{__('For Therapist :: ')}}</label>
                                    <div class="form-group">
                                        <label class="col-form-label">{{__('App ID')}}</label>
