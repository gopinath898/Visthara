    ...
    <div class="card">
        <form action="{{ url('subscription/'.$subscription->id) }}" method="post">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label class="col-form-label">{{__('Availabel Total Sessions')}}</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $subscription->first_description }}" name="first_description" class="form-control @error('first_description') is-invalid @enderror">
                    @error('description')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $subscription->description }}" name="description" class="form-control @error('description') is-invalid @enderror">
                    @error('description')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="registrations-info mt-3">
                    <div class="row form-row reg-cont">
                        <div class="col-12 col-md-4 form-group">
                            ...
                            <input type="number" min="1" name="duration" required class="form-control" value="{{ $subscription->duration }}">
                        </div>
                        <div class="col-12 col-md-4 form-group">
                            <label>{{__('price')}}</label>
                            <input type="number" min="1" name="price" value="{{ $subscription->price }}" required class="form-control">
                        </div>
                        <div class="col-12 col-md-4 form-group">
                            <label>{{__('Discount %')}}</label>
                            <input type="number" min="0" name="discount" value="{{ $subscription->discount}}" class="form-control">
                        </div>
                    </div>
                </div>


                <label class="col-form-label" style="display: none;">{{__('Subscription plan validity and price')}}</label>
                <div class="registrations-info mt-3">
