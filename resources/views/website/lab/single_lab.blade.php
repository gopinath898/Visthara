                            ...
                            <div class="appointment-form">
                                ...
                                <div class="pb-4">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md">
                                            <div>
                                                <label for="" class="form-label mb-1">{{__('Client Age')}}</label>
                                ...
                                <div class="pb-4">
                                    <div class="row g-2">
                                        <div class="col-md">
                                            <div>
                                                <label for="" class="form-label mb-1">{{__('Client Gender')}}</label>
                                        ...
                                        <div class="schedule bg-white rounded-3 h-100 ">
                                            ...
                                            <div class="p-3 pathelogy_disp pt-2 ">
                                                ...
                                                <div class="row mt-3 disp-none presciption_required">
                                                    <div class="col-md-6 col-lg-6">
                                                        <label for="" class="form-label mb-1">{{__('Select Therapist')}}</label>
                                                        <select name="doctor_id" id="doctor_id" class="form-control @error('doctor_id') is-invalid @enderror">
                                                            <option value="">{{__('Please Select Therapist')}}</option>
