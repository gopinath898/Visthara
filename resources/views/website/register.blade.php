...
@section('title',__('Client Register'))
        ...
        <div class="content mx-auto">
            <div class="row g-0">
                <div class="col-xl-5 col-md-6">
                    <div class="d-flex h-100 login-img align-items-center justify-content-center">
                        ...
                        <div
                            ...
                            <form action="{{ url('sign_up') }}" method="post" class="pt-3 w-100">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="pt-4">
                                    <p class="already-text text-center">
                                    <input type="checkbox" name="t&c_checked" style="height: auto;" value={{'checked' ? 1 : 0}} required><span>
                                    I Agree to accept all <a href="{{ url('terms-and-conditions') }}"><u>terms and conditions</u></a></span></p>
                                </div>
