...
Route::group(['middleware' => ['XssSanitizer']], function () 
{
    ...
    Route::get('/show-therapist',[WebsiteController::class,'doctor']);
    Route::post('/show-doctors',[WebsiteController::class,'doctor']);
    Route::get('/therapist_profile/{id}/{name}',[WebsiteController::class,'doctor_profile']);
    ...
    Route::get('/subscriptions',[WebsiteController::class,'websubscription']);

    Route::get('/how-it-works',[WebsiteController::class,'how_it_works']);
    Route::get('/contact',[WebsiteController::class,'contact']);
    Route::post('/submit-query',[EnquiryController::class,'submitQuery'])->name("submit-query");


    Route::get('/faq',[WebsiteController::class,'faq']);
    Route::get('/terms-and-conditions',[WebsiteController::class,'terms_and_conditions']);
    Route::get('/privacy-policy',[WebsiteController::class,'privacy_policy']);
    Route::get('/cookies-policy',[WebsiteController::class,'cookies_policy']);
    Route::get('/policy-terms',[WebsiteController::class,'policy_terms']);
    ...
    Route::get('/free-report',[WebsiteController::class,'pharmacy_product']);

    

    Route::post('/finalsubmit',[WebsiteController::class,'finalsubmit']);
    ...
    Route::get('/resources',[WebsiteController::class,'blogs']);




    Route::get('/specializations',[WebsiteController::class,'specializations']);

    Route::get('/treatment-list',[WebsiteController::class,'treatments']);
    ...
    Route::post('/paymentverify',[WebsiteController::class,'paymentverify']);

    Route::get('/paymentverify',[WebsiteController::class,'paymentverify']);
    
    Route::middleware(['auth'])->group(function ()
    {

        Route::get('/assesment/{id}/{name}',[WebsiteController::class,'assesment']);


        Route::get('/startchat',[WebsiteController::class,'startchat']);

        Route::get('/assesmentsingle/{id}/{name}',[WebsiteController::class,'assesmentsingle']);

        Route::get('/user_profile',[WebsiteController::class,'user_profile']);
        Route::get('/download-invoice/{packageId}',[WebsiteController::class,'downloadInvoice']);

        Route::get('/download-invoice-user/{packageId}',[WebsiteController::class,'downloadInvoiceuser']);
        ...
        Route::post('/booking/{id}/{name}',[WebsiteController::class,'booking']);

        Route::get('/packagebooking/{id}/{name}',[WebsiteController::class,'packagebooking']);
        Route::post('/bookAppointment',[WebsiteController::class,'bookAppointment']);

        Route::get('/buy-package',[WebsiteController::class,'buyPackage']);
        Route::post('/buySubscription',[WebsiteController::class,'buySubscription']);

        Route::get('/instapay',[WebsiteController::class,'instapay']);
        ...
        Route::post('uploadDocument',[WebsiteController::class,'uploadDocument']);
    ...
    Route::middleware(['auth','cors'])->group(function ()
    {
        ...
        Route::get('/enquiries',[EnquiryController::class,'enquiries']);
        ...
        Route::resources([
            ...
            'faq_data' => RadiologyCategoryController::class,
            'faq_category' => FaqCategoryController::class
        ]);

        Route::get('patient/buy-subscription/{id}', [UserController::class,'buy_subscription']);
        Route::get('getPackageDetails/{id}', [UserController::class,'getPackageDetails']);

        Route::get('get-conversations', 'ConversationController@get_conversations')->name('get_conversations');
        
        Route::get('/conversation/{id}', 'ConversationController@view')->name('admin.message.view');
        ...
        Route::get('/display_timeslot/{id}/{index}',[DoctorController::class,'display_timeslot']);
        ...
        Route::post('/create_timeslot',[DoctorController::class,'create_timeslot']);
        Route::post('/doctor/doc_change_password',[DoctorController::class,'change_password']);
        Route::resource('therapy',DoctorController::class)->except([
            'show'
        ]);
        
        Route::get('schedule-therapist',[DoctorController::class,'showTherapistToSchedule']);

        Route::get('/therapy/myprofile',[DoctorController::class,'myprofile']);
        ...
        Route::get('/editAppointment/{appintment_id}',[AppointmentController::class,'editAppointment']);


        Route::put('/sessionupdate/{appintment_id}',[AppointmentController::class,'sessionupdate']);
    
        
        Route::get('/sessions/{appintment_id}',[SessionController::class,'index']);
        Route::get('/completeSession/{session_id}',[SessionController::class,'completeSession']);

        Route::get('/bank_details',[App\Http\Controllers\Doctor\DoctorController::class,'bank_details']);
        ...
        Route::POST('/faq_category/change_status',[FaqCategoryController::class,'change_status']);
        ...
        // commission
        Route::get('show_appointment/{appointment_id}/{session_id}',[AppointmentController::class,'show_appointment']);
        Route::get('view_attachments/{appointment_id}',[AppointmentController::class,'view_attachments']);
        Route::get('show_sessions/{appointment_id}',[SessionController::class,'show_sessions']);
        Route::post('bookSession',[SessionController::class,'bookSession']);
    ...
    /******* DOCTOR PANEL */
    Route::get('/therapy/therapy_login',[App\Http\Controllers\Doctor\DoctorController::class,'doctorLogin']);
    Route::get('/therapy/therapy_signup',[App\Http\Controllers\Doctor\DoctorController::class,'doctorSignup']);
    ...
    Route::middleware(['auth'])->group(function ()
    {
        ...
        // doctor profile
        Route::get('/therapist_profile',[App\Http\Controllers\Doctor\DoctorController::class,'therapist_profile']);
        Route::post('/update_doctor_profile',[App\Http\Controllers\Doctor\DoctorController::class,'update_doctor_profile']);

        Route::post('/update_doctor_bank',[App\Http\Controllers\Doctor\DoctorController::class,'update_doctor_bank']);
        ...
        Route::get('acceptAppointment/{appointment_id}/{session_id}',[AppointmentController::class,'acceptAppointment']);
        Route::get('cancelAppointment/{appointment_id}/{session_id}',[AppointmentController::class,'cancelAppointment']);
        Route::get('completeAppointment/{appointment_id}/{session_id}',[AppointmentController::class,'completeAppointment']);

        // doctor review
        Route::get('doctor_review',[App\Http\Controllers\Doctor\DoctorController::class,'doctor_review']);

        Route::get('doctor_review/delete',[App\Http\Controllers\Doctor\DoctorController::class,'doctor_delete']);
        Route::get('doctor_review/update',[App\Http\Controllers\Doctor\DoctorController::class,'update_review']);
